...
<body>
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                <div class="col-lg-6 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" data-wow-delay="0.1s" src="img/test-image.png">
                </div>
                <div class="col-lg-5 col-md-7 wow fadeInUp" data-wow-delay="0.3s">
                    <p class="text-primary mb-0">About</p>
                    <h1 class="display-5 text-primary mb-4">Venture' Lab</h1>

                    <!-- <h1 class="display-5 mb-4"></h1> -->
                    <p class="mb-4 justify-para">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime neque
                        eveniet totam
                        pariatur quod quam reiciendis id, quisquam quas odio suscipit, placeat praesentium nihil
                        officiis. Numquam voluptatem dolore dignissimos perferendis.Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Maxime neque eveniet totam
                        pariatur quod quam reiciendis id, quisquam quas odio suscipit, placeat praesentium nihil
                        officiis.Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime neque eveniet totam
                        pariatur quod quam reiciendis id, quisquam quas odio suscipit, placeat praesentium nihil
                        officiis. Numquam voluptatem dolore dignissimos perferendis.
                        pariatur quod quam reiciendis id, quisquam quas odio suscipit, placeat praesentium nihil
                        officiis. Numquam voluptatem dolore dignissimos perferendis.
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">Venture' Lab</p>
                <h1 class="display-5 mb-5">News and Events</h1>
            </div>
            <div class="row g-4">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">Venture' Lab</p>
                <h1 class="display-5 mb-5">Community</h1>
            </div>
            ...
            <div class="text-center">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <a href="community.php" class="btn btn-primary py-3 px-4" href="">Explore More</a>
                </div>
            </div>
